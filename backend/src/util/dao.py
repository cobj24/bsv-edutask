...
class DAO:
    ...
    def __init__(self, collection_name: str):
        ...
        it will be associated to a validator (see https://www.mongodb.com/docs/manual/core/schema-validation/) 
    ...
    def create(self, data: dict):
        ...
        The creation of a new document must comply to the corresponding validator, which defines 
        the data structure of the collection. In particular, the validator has to make sure that: 
        ...
        (3) and the values of a property flagged with 'uniqueItems' are unique among all documents of 
        the collection.
        ...
        returns:
            object -- the newly created MongoDB document (parsed to a JSON object) containing the input 
            data and an _id attribute
